...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_5es7zjf', 'template_pfi9h8k', formRef.current, {
        publicKey: 'NVWWSUyb_pMTmyVy4',
      })
      .then(
        (result) => {
            setSuccess(true)
    ...
    <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>futuretechleader@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
                <span>Tech Strret Athlone</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+353 089235698</span>
            </motion.div>
        </motion.div>
